...
def generate_sa_id_number():
    ...
    checksum = str(random.randint(0, 999)).zfill(3)  # Generate 3 digits for race and sex

    id_number = birth_date + random_digits + checksum
    return id_number
...
def generate_sa_id_number():
    ...
    citizienship_and_checksum = str(random.randint(0, 999)).zfill(3)  # Generate 3 digits for race and sex

    id_number = birth_date + random_gender_digits + citizienship_and_checksum
